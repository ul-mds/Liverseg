...
def get_liverseg_multiclients_lits(cfg,dataset_name):
    ...
    if dataset_name=='ircad':
        ...
        #img_paths = sorted(glob(os.path.join(cfg.lits_data_path,"*",'img*')))
        #mask_paths = sorted(glob(os.path.join(cfg.lits_data_path,"*",'mask*')))
        client1_training_img_paths = sorted(glob(os.path.join(cfg.lits_data_path,"training","client_1","*",'img*')))
        client1_training_mask_paths = sorted(glob(os.path.join(cfg.lits_data_path,"training","client_1","*",'mask*')))

        client2_training_img_paths = sorted(glob(os.path.join(cfg.lits_data_path,"training","client_2","*",'img*')))
        client2_training_mask_paths = sorted(glob(os.path.join(cfg.lits_data_path,"training","client_2","*",'mask*')))

        client3_training_img_paths = sorted(glob(os.path.join(cfg.lits_data_path,"training","client_3","*",'img*')))
        client3_training_mask_paths = sorted(glob(os.path.join(cfg.lits_data_path,"training","client_3","*",'mask*')))
        #val_img_paths = sorted(glob(os.path.join(cfg.lits_data_path,"val","*",'img*')))
        #val_mask_paths = sorted(glob(os.path.join(cfg.lits_data_path,"val","*",'mask*')))

        client1_test_img_paths = sorted(glob(os.path.join(cfg.lits_data_path,"client_1","test","*",'img*')))
        client1_test_mask_paths = sorted(glob(os.path.join(cfg.lits_data_path,"client_1","test","*",'mask*')))

        client2_test_img_paths = sorted(glob(os.path.join(cfg.lits_data_path,"client_2","test","*",'img*')))
        client2_test_mask_paths = sorted(glob(os.path.join(cfg.lits_data_path,"client_2","test","*",'mask*')))

        client3_test_img_paths = sorted(glob(os.path.join(cfg.lits_data_path,"client_3","test","*",'img*')))
        client3_test_mask_paths = sorted(glob(os.path.join(cfg.lits_data_path,"client_3","test","*",'mask*')))

       	image_set = client1_training_img_paths + client1_test_img_paths
        mask_set = client1_training_mask_paths + client1_test_mask_paths

        set1 = LivSegDataset(cfg, image_set, mask_set)
        
        image_set = client2_training_img_paths + client2_test_img_paths
        mask_set = client2_training_mask_paths + client2_test_mask_paths

        set2 = LivSegDataset(cfg, image_set, mask_set)

        image_set = client3_training_img_paths + client3_test_img_paths
        mask_set = client3_training_mask_paths + client3_test_mask_paths

        set3 = LivSegDataset(cfg, image_set, mask_set)
...
def prepare_multiple_datasets(cfg):
    print(cfg)
    ircad_training_set, ircad_test_set = get_liverseg_multiclients_lits(cfg, "ircad")
    lits_training_set, lits_test_set = get_liverseg_multiclients_lits(cfg, "lits")

    
    #sliver_training_set, sliver_test_set = get_liverseg(cfg, "sliver")
    
    ircad_image_sets = get_liverseg(cfg, "ircad")
    lits_image_sets1, lits_image_sets2, lits_image_sets3  = get_liverseg(cfg, "lits")
    
    lits_num_total_1 = len(lits_image_sets1)
    lits_num_test_1 = int(0.2*lits_num_total_1)
    lits_num_train_1 = lits_num_total_1 - lits_num_test_1
    
    lits_num_total_2 = len(lits_image_sets2)
    lits_num_test_2 = int(0.2*lits_num_total_2)
    lits_num_train_2 = lits_num_total_2 - lits_num_test_2

    lits_num_total_3 = len(lits_image_sets3)
    lits_num_test_3 = int(0.2*lits_num_total_3)
    lits_num_train_3 = lits_num_total_3 - lits_num_test_3
    ...
    lits_training_set_1, lits_test_set_1 = random_split(lits_image_sets1, [lits_num_train_1, lits_num_test_1], torch.Generator().manual_seed(2023))
    lits_training_set_2, lits_test_set_2 = random_split(lits_image_sets2, [lits_num_train_2, lits_num_test_2], torch.Generator().manual_seed(2023))
    lits_training_set_3, lits_test_set_3 = random_split(lits_image_sets3, [lits_num_train_3, lits_num_test_3], torch.Generator().manual_seed(2023))
    ...
    with open('lits_training1.pkl','wb') as f: pickle.dump(lits_training_set, f)
    with open('lits_test1.pkl','wb') as f: pickle.dump(lits_test_set, f)
    with open('lits_training2.pkl','wb') as f: pickle.dump(lits_training_set, f)
    with open('lits_test2.pkl','wb') as f: pickle.dump(lits_test_set, f)
    with open('lits_training3.pkl','wb') as f: pickle.dump(lits_training_set, f)
    with open('lits_test3.pkl','wb') as f: pickle.dump(lits_test_set, f)

    
    with open('ircad_training_4.pkl','wb') as f: pickle.dump(ircad_training_set, f)
    with open('ircad_test_4.pkl','wb') as f: pickle.dump(ircad_test_set, f)
    
    lits_training_set_1, lits_test_set_1 = pickle.load(open('lits_training_client1.pkl', 'rb')), pickle.load(open('lits_test_client1.pkl', 'rb'))
    lits_training_set_2, lits_test_set_2 = pickle.load(open('lits_training_client2.pkl', 'rb')), pickle.load(open('lits_test_client2.pkl', 'rb'))
    lits_training_set_3, lits_test_set_3 = pickle.load(open('lits_training_client3.pkl', 'rb')), pickle.load(open('lits_test_client3.pkl', 'rb'))

    ircad_training_set_4, ircad_test_set_4 = pickle.load(open('ircad_training_4.pkl', 'rb')), pickle.load(open('ircad_test_4.pkl', 'rb'))
    
    #all_test_set = ircad_test_set + lits_test_set + sliver_test_set
    #all_test_set = ircad_test_set + lits_test_set
    all_test_set = lits_test_set_1 + lits_test_set_2 + lits_test_set_3 + ircad_test_set_4
    #print("test set size")
    ...
    testsets = [lits_test_set_1,lits_test_set_2,lits_test_set_3,ircad_test_set_4, all_test_set]
    
    #valsets = [lits_val_set, ircad_val_set]
    #trainsets = [lits_training_set, ircad_training_set]
    trainsets = [lits_training_set_1,lits_training_set_2,lits_training_set_3, ircad_training_set_4]
